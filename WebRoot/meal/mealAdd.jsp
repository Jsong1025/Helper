					...
					<div class="span9">
						...
						<div class="widget">
							...
							<div class="tab-content">
								...
								<form id="edit-profile" class="form-horizontal" action="mealAdd.do" method="post">
									<fieldset>
										...
										<div class="control-group">											
											...
											<div class="controls">
												<input type="date" class="input-medium" name="startTime" id="startTime" value="" />
											</div> <!-- /controls -->				
										</div> <!-- /control-group -->
										...
										<div class="control-group">											
											...
											<div class="controls">
												<input type="date" class="input-medium" name="endTime" id="endTime" value="" />
											</div> <!-- /controls -->				
										</div> <!-- /control-group -->
										...
										<div class="control-group">											
											...
											<div class="controls">
												<input type="text" class="input-medium" name="num" id="num" value="" />
											</div> <!-- /controls -->				
										</div> <!-- /control-group -->
										...
										<div class="control-group">											
											...
											<div class="controls">
												<input type="text" class="input-medium" name="price" id="price" value="" />
											</div> <!-- /controls -->				
										</div> <!-- /control-group -->
										...
										<div class="control-group">											
											...
											<div class="controls">
												<input type="text" class="input-large" name="priferemential" id="priferemential" value="" />
											</div> <!-- /controls -->				
										</div> <!-- /control-group -->
