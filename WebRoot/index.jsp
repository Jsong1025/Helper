...
<li>
  ...
  <ul class="an"><!--搜索按钮--></li>
          ...
          <ul class="nav navbar-nav navbar-right">
              <li><button type="button" class="btn btn-default navbar-btn"  title="登录" onclick="window.location.href='login.html'" >登录</button></li>
              <li><button type="button" class="btn btn-primary navbar-btn" title="注册" onclick="window.location.href='regist.html'">注册</button></li>
            </ul>
