								...
								<form id="edit-profile" class="form-horizontal" action="appointmentUpdate.do" method="post">
									<fieldset>
										...
										<div class="control-group">											
											...
											<div class="controls">
												<input type="date" class="input-medium" id="startTime" name="startTime" value="<%= appointment.getStartTime() %>" />
											</div> <!-- /controls -->				
										</div> <!-- /control-group -->
										...
										<div class="control-group">											
											...
											<div class="controls">
												...
												<% for(int i=0; i<users.size();i++){ %>
													<option value="<%= users.get(i).getId() %>" <% if(appointment.getUserId()==users.get(i).getId()) {%>selected<%} %>><%= users.get(i).getName() %></option>
												<%} %>
												</select>
											</div> <!-- /controls -->				
										</div> <!-- /control-group -->
										...
										<div class="control-group">											
											...
											<div class="controls">
												<select name="otherUser">
													<% for(int i=0; i<users.size();i++){ %>
													<option value="<%= users.get(i).getId() %>" <% if(appointment.getOtherUserId()==users.get(i).getId()) {%>selected<%} %> ><%= users.get(i).getName() %></option>
												<%} %>
												</select>
											</div> <!-- /controls -->				
										</div> <!-- /control-group -->
										...
										<div class="control-group">											
											...
											<div class="controls">
												<select name="meal">
													...
													<option value="<%= meals.get(i).getId() %>" <% if(appointment.getMealId()==meals.get(i).getId()) {%>selected<%} %> ><%= meals.get(i).getName() %></option>
												<%} %>
												</select>
											</div> <!-- /controls -->				
										</div> <!-- /control-group -->
										...
										<div class="control-group">											
											...
											<div class="controls">
												<input type="text" class="input-large"  id="description" value="<%= appointment.getEndTime() %>" />
											</div> <!-- /controls -->				
										</div> <!-- /control-group -->
